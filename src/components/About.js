			...
			<section id="about">
				...
				<div classsName="intro-p">
					...
					<p className="bio-p">
						...
						I've worked in varied projects which showcase in github in which I've had the chance to experiment with different technologies that enable front end development to be more proficient. All of my work is produced from Portugal. What would you do if you had a software expert available at your fingertips?
					</p>
				</div>
			</section>
		);
